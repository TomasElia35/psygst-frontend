...
/* ============================================================
   MaintenanceMode — PsyGst
   Shown when VITE_MAINTENANCE_MODE=true.
   Blocks ALL routes; no navigation possible.
   ============================================================ */
    ...
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.badge}>
          ...
          <span>Actualización en curso{dots}</span>
        </div>
        ...
        {/* Description */}
        <p style={styles.desc}>
          Estamos realizando una actualización crítica de la base de datos para
          mejorar la seguridad y el rendimiento del sistema. Durante este proceso
          el acceso está temporalmente suspendido.
        </p>
        ...
        <div style={styles.infoGrid}>
          <InfoBlock icon="🔒" label="Datos seguros" text="Tu información está protegida. No se pierde ningún dato." />
          <InfoBlock icon="⚡" label="Alta disponibilidad" text="El sistema volverá en breve con mejoras importantes." />
          <InfoBlock icon="📋" label="Sin acción requerida" text="No es necesario que hagas nada. Reintentá más tarde." />
        </div>

        {/* Footer */}
        <p style={styles.footer}>
          Si tenés una urgencia, contactá al administrador del sistema.
        </p>
      </div>
